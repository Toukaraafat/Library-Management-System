    ...
    @endif
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">{{ __('Controller') }}</div>
                                <div class="container">
                                    <h1 class="mt-3">Controller</h1>
                                
                                    <div class="row mt-4">
                                        <div class="col-md-6">
                                            <h2><a href="{{ route('books.index') }}">Books</a></h2>
                                            <ul class="list-group">
                                        ...
                                        <div class="col-md-6">
                                            <h2><a href="{{ route('authors.index') }}">Authors</a></h2>
                                            <ul class="list-group">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-6">
                                            <h2><a href="{{ route('managers.index') }}">Managers</a></h2>
                                            <ul class="list-group">
